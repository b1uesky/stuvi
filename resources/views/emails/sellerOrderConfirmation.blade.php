                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td align="center" style="-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;" bgcolor="#00A496">
                                                                                    <a href="{{ url('/order/seller/'.$seller_order['id']) }}" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; padding: 12px 18px; border: 1px solid #e9703e; display: inline-block;">
                                                                                        Schedule Pick-up &rarr;</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td valign="top" style="color: #000000;" width="10%">
                                                                        <a href="{{ url('/order/seller/'.$seller_order['id']) }}">
                                                                            <img src="{{ config('aws.url.stuvi-book-img').$seller_order['product']['book']['image_set']['small_image'] }}" alt="{{ $seller_order['product']['book']['title'].'cover image' }}" width="75px" height="100px">
                                                                        </a>
                                                                        <br>
                                                                    </td>
                                                                    <!-- spacing -->
