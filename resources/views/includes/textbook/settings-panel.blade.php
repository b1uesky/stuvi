<div class="panel panel-default">
    ...
    <div class="list-group">
        ...
        <a class="list-group-item {{ Request::path() == 'user/bookshelf' ? 'active' : '' }}" href="{{ url('user/bookshelf') }}">My Bookshelf</a>
        <a class="list-group-item {{ Request::path() == 'user/reminder' ? 'active' : '' }}" href="{{ url('user/reminder') }}">My Textbook Reminders</a>
    </div>
</div>