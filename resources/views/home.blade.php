...
<!-- top jumbotron -->
    ...
    * Photo by Nick Louie.
    ...
    <!-- TODO: Make carousel http://www.w3schools.com/bootstrap/bootstrap_ref_js_carousel.asp   http://www.slidesjs.com/ -->

{{--    <div class = "container-fluid container-top backgnd">           <!-- Top half -->
        <nav class="navbar navbar-default" id="nav" role="navigation" style="position: absolute; top: 0;">
